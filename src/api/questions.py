...
from src.models.question import QuestionGetter, QuestionSetter, AnswerOnQuestion
...
async def add(data: QuestionSetter, session: AsyncSession = Depends(get_session)):
